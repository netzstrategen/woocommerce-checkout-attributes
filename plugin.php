...
/*
  Plugin Name: WooCommerce Checkout Attributes
  Version: 1.0.0
  Text Domain: woocommerce-checkout-attributes
  Description: Shows product attributes on cart page and on all checkout steps.
